/* GTBITIO3.H, Ver. 3, 8/22/2022, 6/27/2023 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <limits.h>
...
static inline unsigned int get_nbits( int size );
static inline void put_nbits( unsigned int k, int size );
static inline int get_symbol( int size );
